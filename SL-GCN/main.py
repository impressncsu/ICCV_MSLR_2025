...
class Processor():
    ...
    def __init__(self, arg):
        ...
        #arg.model_saved_name = "./save_models/" + arg.Experiment_name     # it was like this before
        arg.model_saved_name = "./save_models/" + arg.Experiment_name + "/epoch"   # I added this
    ...
    def train(self, epoch, save_model=False):
        ...
        #torch.save(weights, self.arg.model_saved_name +'-' + str(epoch) + '.pt') # it was like his before
        model_dir = os.path.dirname(self.arg.model_saved_name)   # I added this
        os.makedirs(model_dir, exist_ok=True)          # I added this
        torch.save(weights, f"{self.arg.model_saved_name}-{epoch}.pt")          # I added this

    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        if wrong_file is not None:
            os.makedirs(os.path.dirname(wrong_file), exist_ok=True) #i added this 
            f_w = open(wrong_file, 'w')
        if result_file is not None:
            os.makedirs(os.path.dirname(result_file), exist_ok=True) # i added this
...
if __name__ == '__main__':
    ...
    if p.config is not None:
        with open(p.config, 'r') as f:
            default_arg = yaml.load(f,  Loader=yaml.FullLoader) #, Loader=yaml.FullLoader added this
        key = vars(p).keys()
